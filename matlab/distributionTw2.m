...
test_0 = q2*(1-P21_2) ; 
%test_0 = (1-P01_2)*(1-P21_2) ; %wrong
%test_0 =  P02_2*(1-P21_2) + P20_2*(1-P01_2); %wrong
%test_1 = P0*alpha(1,2)+P1+P2*alpha(3,2) ;
%test_1 = P0*(1-P10)*(1-P12) + P0*pi(3)*(1-P10)*(1-P12) +  P0*pi(1)*(1-P10)*(1-P12) + (1-P10)*(1-P12) + P2*(1-P10)*(1-P12) + P2*pi(3)*(1-P10)*(1-P12) + P2*pi(1)*(1-P10)*(1-P12)
%test_1 = P0*(1-P10)*(1-P12) + P0*pi(3)*(1-P10)*(1-P12)+ (1-P10)*(1-P12) + P2*(1-P10)*(1-P12) + P2*pi(1)*(1-P10)*(1-P12)
test_1 = ((1-P10_2)*(1- P12_2))*((P01_2+P02_2*newpi(3)*P21_2)+(P21_2+P20_2*newpi(1)*P01_2)+1)
%test_1 = ((1-P10_2)*(1-P12_2))*((P01_2+P02_2*newpi(3)*newpi(1)*newpi(3)*P21_2)+(P21_2+P20_2*newpi(1)*newpi(3)*newpi(1)*P01_2)+q1)



%f1 = P10*alpha(4) + P12*alpha(6) 
%f1 = P10_2*(alpha(1,2)+(alpha(1,3)*alpha(3,2))) +P12_2*(alpha(3,2)+(alpha(3,1)*alpha(1,2))); 
f1 = P10_2*(P01_2 + P02_2*newpi(3)*P21_2) +P12_2*(P21_2+(P20_2*newpi(1)*P01_2)); 
...
%alpha2 = P^13
test2_0 = q1*(1-P12_2) ; 
%test2_0 = (1-P02_2)*(1-P12_2); %wrong
%test2_0 = P0*P01_2 + P0*alpha(1,2)*alpha(2,1) + P1*P10_2+P1*alpha(2,1)*alpha(1,2)

test2_1 = ((1-P20_2)*(1-P21_2))*((P02_2+P01_2*newpi(2)*P12_2)+(P12_2+P10_2*newpi(1)*P02_2)+1)
%test2_1 = ((1-P20_2)*(1-P21_2))*((P02_2+P01_2*newpi(2)*newpi(1)*newpi(2)*P12_2)+(P12_2+P10_2*newpi(1)*newpi(2)*newpi(1)*P02_2)+q2)
%test2_1 = q2*(1-P21_2) + q2*P21_2*(1-P12_2)+ q1*P12_2*(1-P21_2)+q1*P12_2*P21_2*(1-P12_2)
